...
const cardRouter = require('./card/card-router');//mport the card router into the app.js 
//connect the router using the app.use method
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//used the card router after we use the validateBearerToken as we want the validation to take place
// before any routes get handled.
app.use(cardRouter); //connect cardRouter using app.use method
app.use(listRouter);
